class Zerostack < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/gi-dellav/zerostack/releases/download/v1.5.1/zerostack-x86_64-apple-darwin.tar.gz"
      sha256 "0c5ce2d6cc251bb6dd782f250a321bbb13084d0e88a9536d9d86d7b04a5779e0"
    else
      url "https://github.com/gi-dellav/zerostack/releases/download/v1.5.1/zerostack-aarch64-apple-darwin.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/gi-dellav/zerostack/releases/download/v1.5.1/zerostack-x86_64-unknown-linux-musl.tar.gz"
      sha256 "b8b35c4afdc5866ec137e1c15d3dfe47382bc05be17c1360fff1c0382a912aff"
    else
      url "https://github.com/gi-dellav/zerostack/releases/download/v1.5.1/zerostack-aarch64-unknown-linux-musl.tar.gz"
