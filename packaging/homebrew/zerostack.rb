class Zerostack < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/gi-dellav/zerostack/releases/download/v1.6.0/zerostack-x86_64-apple-darwin.tar.gz"
      sha256 "fdd814adeb5988f40106eaed7720c53bd4e0d2cf26d9b0b48e51cda573a6faa1"
    else
      url "https://github.com/gi-dellav/zerostack/releases/download/v1.6.0/zerostack-aarch64-apple-darwin.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/gi-dellav/zerostack/releases/download/v1.6.0/zerostack-x86_64-unknown-linux-musl.tar.gz"
      sha256 "854232371f44f1493c9b5f0046656a9c4f1a9376b2c7a050f5555657708d5ec3"
    else
      url "https://github.com/gi-dellav/zerostack/releases/download/v1.6.0/zerostack-aarch64-unknown-linux-musl.tar.gz"
